            ...
            <div className="flex flex-col  justify-center items-center w-full mb-4">
                ...
                <div className="flex flex-row w-full items-center justify-center">
                    <div className=" text-white flex flex-col items-center bg-black opacity-95 py-1 mt-8 w-4/12 shadow-2xl border-2 border-teal-300/50 z-50 rounded-full">
                        ...
                        <input  className="text-white flex flex-col justify-center items-center bg-black opacity-95 py-1 mt-8 w-2/12 shadow-2xl border-2 border-teal-300/50 z-50 rounded-full text-center" placeholder="Amount"/>
                </div>
                <div className="flex flex-col  justify-center items-center w-full mb-4">
                {/* Second Token Line */}
                <div className="flex flex-row w-full items-center justify-center">
                ...
                <div className="flex flex-row w-full justify-evenly items-center"> 
                        <div className="flex flex-col bg-black opacity-95 py-1 mt-8 w-2/12 shadow-2xl border-2 border-teal-300/50 z-50 rounded-full hover:border-teal-200 hover:text-teal-300">
                            <button 
                            onClick={executeSwap}
                            className="bg-transparent outline:none focus:outline-none text-gray-400 hover:text-teal-300">Swap</button>
                        </div>
                    </div>    
            </div>
        </div>
