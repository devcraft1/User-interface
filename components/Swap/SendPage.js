      ...
      <div className="flex flex-col items-center just w-full  border-r border-b bg-gradient-to-t from-gray-500/5 rounded-xl shadow-xl">
        ...
        <div className="flex flex-col  justify-center items-center w-full mb-4">
          ...
          <div className="flex flex-col w-full items-center justify-evenly">
            ...
            <input
              className="text-white flex flex-col mt-8 justify-center items-center bg-black opacity-95 py-1 w-9/12 shadow-2xl border-2 border-teal-300/50 z-50 rounded-full text-center"
