...
function Card() {
    ...
    const { user, isWeb3Enabled, enableWeb3, isAuthenticated, isWeb3EnableLoading } = useMoralis();
    ...
    return (
        <div className="w-64 h-96 flex flex-col items-center border-r border-b bg-gradient-to-t from-gray-500/5 rounded-xl shadow-xl">
            ...
            <div className="flex items-center my-2 pt-1">
                <Image width={175} height={175} src="/Avatar.png" alt="Item" className="rounded-xl shadow-xl" />
            </div>
